...
const WaitingCalls = () => {
  ...
  return (
    <>
      <div className=" bg-white h-[17vh] rounded-tl">
        <div className="bg-layout 3xl:px-6 3xl:py-2.5 py-1.5 px-3 h-[5.7vh] flex">
          <span className="3xl:text-base text-xs text-heading font-bold flex items-center">
            Waiting Calls
          </span>
        </div>
<div className="flex flex-row gap-3 w-full px-3 pt-3">
  {/* Outbound Call - Left */}
